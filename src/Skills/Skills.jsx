...
export default function SkillCloud() {
  return (
    <div className="relative w-full min-h-screen  flex flex-col md:flex-row justify-center items-center bg-[#f1efec] overflow-hidden pt-16" id='skills'>
      {/* Content */}
      ...
      {/* Canvas */}
      <div className="relative flex justify-center items-center z-20 h-[100%] w-[100%]">
